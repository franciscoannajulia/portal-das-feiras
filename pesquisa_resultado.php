...
<?php 
    ...
    $definicao = $inicio.", ".$limtite;
        $pesquisar = $_POST["pesquisa"];
        $sql = "select * from postagem where Titulo LIKE '%$pesquisar%' OR Tipo LIKE '%$pesquisar%' OR Descricao LIKE '%$pesquisar%' OR Promotor LIKE '%$pesquisar%' LIMIT $inicio, $limite";
...
?>
        ...
        <?php 
        include"databaseconnect.php";
        $sql3 = "select * from anuncio where CodAnuncio=4";
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="container" >
            <h2>Resultados de: "<?php echo $pesquisar?>"</h2>
    </div>
    <!--POSTAGENS-->
        <div class="container">
          <div class="row">
    ...
    <!--End POSTAGENS-->
        ...
        echo ' <li class="page-item"><a style="color:red" class="page-link" href="pesquisa_resultado.php?id=1">Anterior</a></li>';
        if($qtdPag > 1 && $id <= $qtdPag){
        for($i = 1; $i <= $qtdPag; $i++){
                if($i == $id){
                        echo "<li class='page-item'><a style='color:red' class='page-link' href='pesquisa_resultado.php?id='>".$i."</a></li>";
                } else {
                    echo "<li class='page-item'><a style='color:red' class='page-link' href='pesquisa_resultado.php?id=$i'>".$i."</a></li>";
                }
        }
        }
        echo "<li class='page-item'><a style='color:red' class='page-link' href='pesquisa_resultado.php?id=$qtdPag'>Próxima</a></li>";
        echo "</ul></nav></center>";
        ?>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <!--anuncio-->
        <?php 
        include"databaseconnect.php";
        $sql4 = "select * from anuncio where CodAnuncio=6";
