  ...
  <div class="container">
	...
	<table class="table">
        ...
        ?>  
                <tbody>
                    <tr> 
                        <td scope="row"><?php echo $linha["CodAnuncio"]?></td>
                        <td scope="row">
                        <img class="capa" src="../<?php echo $linha["Imagem"]?>">
                        <?php echo $linha["Titulo"]?></td>
                        <td scope="row"><?php echo $linha["Link"]?></td>
                        <td scope="row"><?php echo $linha["Pagina"]?></td>
                                                <td scope="row"><?php echo $linha["Plano"]?></td>
                        <td scope="row"><?php echo $linha["Medida"]?></td>

                                          <td scope="row"><?php echo date('d-m-Y', strtotime($linha ["DataInicio"]))?></td>
                    <td scope="row"><?php echo date('d-m-Y', strtotime($linha ["DataFim"]))?></td>
        ...
        ?>
           ...
           <!-- Modal -->
            ...
            <p>Para excluir, confirme o código do anúncio:</p>
