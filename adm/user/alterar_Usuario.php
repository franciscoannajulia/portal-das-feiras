...
<!--fim Menu-->
  ...
  <div class="container">
    ...
    <header class="jumbotron my-4">
      <h1 class="display-3">Alterar Usuario</h1>
    ...
    <div class="form-row">
          ...
          <input type="text" class="form-control" id="codigo" name="codigo" value="<?php echo $linha["CodUsuario"]?>">
          </div>
      </div>
      <div class="form-row">
          <div class="form-group col-md-6">
      ...
      <div class="form-group col-md-4">
          ...
          <input  type="text" class="form-control" id="login" name="login" value="<?php echo $linha["Usuario"]?>">
          </div>
          <div class="form-group col-md-4">
          <label for="inputCity">Senha:</label>
          <input type="password" class="form-control" id="senha1" name="senha1" value="<?php echo $linha["Senha"]?>">
          </div>
          <div class="form-group col-md-4">
          <label for="inputState">Digite Novamente:</label>
          <input  type="password" class="form-control" id="senha2" name="senha2" placeholder="" value="<?php echo $linha["Senha"]?>">
          </select>
          </div>
      </div>
