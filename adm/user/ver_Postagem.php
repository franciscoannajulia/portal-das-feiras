...
<!--fim Menu-->
  ...
  Postado por:<a href="#">  <?php echo $linha["Autor"]?></a> as <?php echo date('d/m/Y H:i', strtotime($linha ["DataPostagem"]))?> 
             <h2 class="heading-39291"><?php echo $linha["Titulo"]?></h2>
            De <?php echo date('d/m/Y', strtotime($linha["DataInicio"]))?> às <?php echo date('H:i', strtotime($linha["HoraInicio"]))?> até <?php echo date('d/m/Y', strtotime($linha["DataFim"]))?> às <?php echo date('H:i', strtotime($linha["HoraFim"]))?>.</br>
           
            <a href="postagem.php?id=<?php echo $linha["CodPostagem"]?>"> <img src="../../<?php echo $linha["Capa"]?>" width="500px" style="float: right;  padding-left: 140px;" ></a> <p><?php echo $linha["Descricao"]?>.</p>

            <p><b>Informações</b></p>
            Tipo: <?php echo $linha["Tipo"]?></br>
            Periodicidade: <?php echo $linha["Periocidade"]?></br>
            Endereço: <?php echo $linha["Endereco"]?></br>
            Bairro: <?php echo $linha["Bairro"]?></br>
            Cidade: <?php echo $linha["Cidade"]?></br>
            Estado: <?php echo $linha["Estado"]?></br>
            País: <?php echo $linha["Pais"]?></br>
            CEP: <?php echo $linha["CEP"]?></br>
            Local: <?php echo $linha["Local"]?></br>
            Categoria: <?php echo $linha["Categoria"]?></br>
            Segmento: <?php echo $linha["Segmento"]?></br>
            Promotor: <?php echo $linha["Promotor"]?></br>
            Endereço do Promotor: <?php echo $linha["EnderecoPromotor"]?></br>
            Telefone: <?php echo $linha["Telefone"]?></br>
            E-mail: <?php echo $linha["Email"]?></br>
            Site: <?php echo $linha["Site"]?></br>
            
          </br>
            <a class="botao botao-info" href="alterar_Postagem.php?id=<?php echo $linha["CodPostagem"]?>">Editar</a>
