...
<?php include "menu.php";
            $Cemfeira="S";
            $sql = "select * from postagem where CemFeira = :Cemfeira";
        ...
        ?>
                <tbody>
                    ...
                    <td class="rank"><span></span></td>
                                            <td scope="row">
                        <img class="capa" src="../../<?php echo $linha["Capa"]?>">
                        <?php echo $linha["Titulo"]?></td>
                        <td scope="row"><?php echo $linha["Estado"]?></td>
                        <td scope="row"><?php echo $linha["Categoria"]?></td>
                        <td scope="row"><?php echo $linha["Tipo"]?></td>
                        <td scope="row"><?php echo $linha["CodPostagem"]?></td>
                        <td scope="row"><a class="botao botao-success" href="ver_Postagem.php?id=<?php echo $linha["CodPostagem"]?>">Ver</a>
