    ...
    <div class="row">
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
            <h5 class="card-title text-center">Esqueceu a senha? &#128561;</h5>
            <p>Por favor digite seu e-mail.</p>
            <form class="form-signin" action="esqueci_senha2.php" method="post">
              <div class="form-label-group">
                <input type="email" id="email" name="email" class="form-control" >
                <label for="inputEmail">Email</label>
              </div>
              <button class="btn btn-lg btn-anna btn-block text-uppercase" type="submit">Pedir Nova Senha</button>
