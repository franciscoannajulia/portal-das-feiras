...
include "../databaseconnect.php"; 
        ...
        $sql = "select * from administrador where CodAdm = :CodAdm";
...
<!--fim Menu-->
  ...
  <div class="container">
        <p>Código: <?php echo $linha["CodAdm"]?>.<br/></p>
        ...
        <p>Email:  <?php echo $linha["Email"]?>.<br/></p>
                ...
                <a class="botao botao-info" href="alterar_Usuario.php?id=<?php echo $linha["CodAdm"]?>" role="button">Alterar</a>
 ...
 <!-- Modal -->
    <div class="modal fade" id="Apagar" role="dialog">
            ...
            <form id="confirmando" action="excluir_Adm.php" method="post">
