...
<!--fim Menu-->
  ...
  Postado por:<a href="#">  <?php echo $linha["Autor"]?></a> as <?php echo date('d-m-Y H:i:s', strtotime($linha ["DataPostagem"]))?>
             <h2 class="heading-39291"><?php echo $linha["Titulo"]?></h2>
            De <?php echo $linha["DataInicio"]?> à <?php echo $linha["DataFim"]?>.</br>
