...
<?php 
    ...
    $inicio = ($id * $limite) - $limite;
        ...
        //3
        $sql = "select * from postagem where Tipo = 'Negocio' LIMIT $inicio, $limite";
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="container" >
            <h2>Feiras de Negócio</h2>
            <p></p>
            <a class="btn btn-outline-anna" href="feiras.php">Todos</a>
            <a class="btn btn-outline-anna" href="feirasdeagronegocio.php">Feiras de  Agronegócio</a>
            <a class="btn btn-anna" style="color:#fff" href="feirasdenegocio.php">Feiras de Negócio</a>
