...
<?php include "menu.php";
            $Cemfeira="S";
            $sql1 = "select * from postagem where CemFeira = :Cemfeira";
            $result1 = $conn -> prepare($sql1);
            $result1->bindValue(":Cemfeira", $Cemfeira);
            $result1->execute();
?>
<!--fim Menu-->
  ...
  <div class="container">
    ...
    <header class="jumbotron my-4">
      <h1 class="display-3">Cem Maiores Feiras</h1>
    </header>
	...
	<table class="table">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Código da Postagem</th>
        ...
        ?>
                <tbody>
                    ...
                    <td class="rank"><span></span></td>
                                            <td scope="row">
                        <img class="capa" src="../../<?php echo $linha1["Capa"]?>">
                        <?php echo $linha1["Titulo"]?></td>
                        <td scope="row"><?php echo $linha1["Estado"]?></td>
                        <td scope="row"><?php echo $linha1["Categoria"]?></td>
                        <td scope="row"><?php echo $linha1["Tipo"]?></td>
                        <td scope="row"><?php echo $linha1["CodPostagem"]?></td>
                        <td scope="row"><a class="botao botao-success" href="ver_Postagem.php?id=<?php echo $linha1["CodPostagem"]?>">Ver</a>
                        <a class="botao botao-danger" data-toggle="modal" data-target="#Apagar" role="button" style="color: #fff;">Remover das Cem Feiras</a>
                </tbody>
        <?php
        } 
        ?>
           ...
           <!-- Modal -->
            ...
            <h4 class="modal-title">Tem certeza que quer remover?</h4>
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
            <form id="confirmando" action="excluir_Cemfeiras.php" method="post">
            <p>Para excluir, confirme o código da postagem:</p>
            <input class="form-control" name="codigo" placeholder="Código" type="text" tabindex="4" required>
            </div>
