      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item active">
            ...
            <li class="nav-item active">
            <a class="nav-link" href="ver_Anuncios.php">Anúncios
            </a></li>
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
             <a class="dropdown-item" href="equipemkt.php">Equipe Marketing</a>
             <a class="dropdown-item" href="equipeuser.php">Equipe User Normal</a>
           ...
           <li class="nav-item">
            <a class="nav-link" href="perfil_Usuario.php"> <?php echo "@".$linha["Usuario"]?></a>
          </li>
 	    <li class="nav-item">
