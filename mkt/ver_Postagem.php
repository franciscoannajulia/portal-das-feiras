...
<!--fim Menu-->
  ...
  <div class="container">
    ...
    <header class="jumbotron my-4">
      <h1 class="display-3">Código:  <?php echo $CodPostagem?></h1>
    </header>
  ...
  Postado por:<a href="#">  <?php echo $linha1["Autor"]?></a> as <?php echo date('d/m/Y H:i', strtotime($linha ["DataPostagem"]))?> 
             <h2 class="heading-39291"><?php echo $linha1["Titulo"]?></h2>
            De <?php echo date('d/m/Y', strtotime($linha1["DataInicio"]))?> às <?php echo date('H:i', strtotime($linha1["HoraInicio"]))?> até <?php echo date('d/m/Y', strtotime($linha1["DataFim"]))?> às <?php echo date('H:i', strtotime($linha1["HoraFim"]))?>.</br>
           
            <a href="postagem.php?id=<?php echo $linha1["CodPostagem"]?>"> <img src="../<?php echo $linha1["Capa"]?>" width="500px" style="float: right;  padding-left: 140px;" ></a> <p><?php echo $linha1["Descricao"]?>.</p>

            <p><b>Informações</b></p>
            Tipo: <?php echo $linha1["Tipo"]?></br>
            Periodicidade: <?php echo $linha1["Periocidade"]?></br>
            Endereço: <?php echo $linha1["Endereco"]?></br>
            Bairro: <?php echo $linha1["Bairro"]?></br>
            Cidade: <?php echo $linha1["Cidade"]?></br>
            Estado: <?php echo $linha1["Estado"]?></br>
            País: <?php echo $linha1["Pais"]?></br>
            CEP: <?php echo $linha1["CEP"]?></br>
            Local: <?php echo $linha1["Local"]?></br>
            Categoria: <?php echo $linha1["Categoria"]?></br>
            Segmento: <?php echo $linha1["Segmento"]?></br>
            Promotor: <?php echo $linha1["Promotor"]?></br>
            Endereço do Promotor: <?php echo $linha1["EnderecoPromotor"]?></br>
            Telefone: <?php echo $linha1["Telefone"]?></br>
            E-mail: <?php echo $linha1["Email"]?></br>
            Site: <?php echo $linha1["Site"]?></br>
            
          </br>
            <a class="botao botao-info" href="alterar_Postagem.php?id=<?php echo $linha1["CodPostagem"]?>">Editar</a>
            <a class="botao botao-danger" data-toggle="modal" data-target="#Apagar" role="button" style="color: #fff;">Apagar</a> </br><a href="ver_Postagens.php" class="btn btn-secondary">Voltar</a>
