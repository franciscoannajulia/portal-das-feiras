...
$sql1 = "select * from marketing";
 ...
 if($emailbd == $email){
 $sql = "select * from marketing where Email= :email";
...
#centro{
 ...
 <p> Sim -> Por favor, clique nesse <a href='https://portaldasfeiras.com.br/mkt/nova_senha.php' target='_blank'>link</a></p>
 <p> <b>Não -> Por favor, clique aqui e <a href='https://portaldasfeiras.com.br/mkt/denuncia.php' target='_blank' >denuncie esse acesso!</a></b></p>
