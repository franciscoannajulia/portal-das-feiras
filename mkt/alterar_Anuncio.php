...
include "../databaseconnect.php"; 
   ...
   if (isset($_REQUEST["id"]))
	{	
		$CodAnuncio = $_REQUEST["id"];
		$sql1 = "select * from anuncio where CodAnuncio = :CodAnuncio";
		$result1 = $conn -> prepare($sql1);
		$result1->bindValue(":CodAnuncio", $CodAnuncio);
		$result1->execute();
...
<!--fim Menu-->
  ...
  <div class="container">
    ...
    <header class="jumbotron my-4">
      <h1 class="display-3">Alterar Anúncio</h1>
      <!--<p class="lead">Aqui você pode acessar a parte cadastro e visualizar feiras e muito mais.</p>-->
    </header>

    <!-- Page Features -->
    
<form action="alterar_Anuncio2.php" enctype="multipart/form-data" method="post">
          <div class="form-row">
          <div class="form-group col-md-6">
          <label for="inputEmail4">Código: <span style="color:red;">*não alterar</span></label>
          <input type="text" class="form-control" id="codigo" name="codigo" value="<?php echo $linha1["CodAnuncio"]?>">
          </div>
      </div>                  
  <div class="form-row">
    <div class="form-group col-md-6">
   ...
   <div class="form-group col-md-6">
      ...
      <input required class="form-control"  name="link" type="text" id="link" value="<?php echo $linha1["Link"]?>">
    </div>
  </div>
    ...
    <div class="form-group col-md-6">
      <label for="formGroupExampleInput">Plano:</label>
        ...
        <option value="<?php echo $linha1["Plano"]?>"><?php echo $linha1["Plano"]?></option>
    ...
    <div class="form-row">
      ...
      <select  class="form-control"  name="medida" id="medida">
        <option value="<?php echo $linha1["Medida"]?>"><?php echo $linha1["Medida"]?></option>
    ...
    <div class="form-group col-md-6">
      ...
      <select  class="form-control"  name="pagina" id="pagina">
        <option value="<?php echo $linha1["Pagina"]?>"><?php echo $linha1["Pagina"]?></option>
    ...
    <div class="form-row">
      ...
      <label for="formGroupExampleInput" style="color:red">Alterar imagem?*IMPORTANTE RESPONDER PARA CONCLUIR A ALTERAÇÃO</label>
      ...
      <br><b><?php echo $linha1["Imagem"];?></b><p><input type="file" id="imagem" name="imagem"><br></p>
